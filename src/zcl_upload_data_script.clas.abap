class zcl_upload_data_script definition
  public
  final
  create public .
...
class zcl_upload_data_script implementation.
...
******** TABLA1 ********
    ...
    delete from ztacccateg_log. "#EC CI_NOWHERE.
    insert ztacccateg_log from table @lt_acc_categ.
...
******** TABLA3 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztclientes_log.
    insert ztclientes_log from table @lt_clientes.
...
******** TABLA4
    ...
    "Delete possible entries; insert new entries
    delete from ztclnt_lib_log.
    insert ztclnt_lib_log from table @lt_clnts_lib.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztlibros_log.
    insert ztlibros_log from table @lt_libros.
