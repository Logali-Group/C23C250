class lhc_Travel definition inheriting from cl_abap_behavior_handler.
  private section.
   ...
   constants :
      ...
      types:
          t_entities_create type table for create zr_travel_250_a\\Travel,
          t_entities_update type table for update zr_travel_250_a\\Travel,
          t_failed_travel type table for failed early zr_travel_250_a\\Travel,
          t_reported_travel type table for reported early zr_travel_250_a\\Travel.
...
class lhc_Travel implementation.
  ...
  method get_instance_features.
   ...
   read entities of zr_travel_250_a in local mode
         entity Travel
  ...
  read entities of zr_travel_250_a in local mode
   ...
   check lt_travels is not  initial.
    ...
    select from zr_travel_250_a as travel
  ...
  method acceptTravel.
     ...
     modify entities of zr_travel_250_a in local mode
           entity Travel
...
" reported-travel[ 1 ]-
   ...
   data lt_travel_for_update type table for update zr_travel_250_a.
